var EDSA = (function() {
  function App(opts) {
    ...
    this.$els.sections.find('h3:first,h4:first,h5:first,h6:first').on('click', this.onHeadingClick.bind(this));
  ...
  App.prototype = {
    ...
    handleMobileDevices: function(){
      ...
      this.$els.sections.find('h3:first,h4:first,h5:first,h6:first').onTap(this.onHeadingClick.bind(this));
    },
