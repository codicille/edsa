...
// Touch
App.IS_TOUCH_DEVICE = window.ontouchend !== void 0;
...
html.className += App.IS_TOUCH_DEVICE ? ' touch' : ' no-touch';
html.className += App.HAS_TRANSITIONS ? ' transitions' : ' no-transitions';
html.className += App.HAS_SVG ? ' svg' : ' no-svg';
html.className += App.IS_RETINA ? ' retina' : ' no-retina';
